				...
				options: [
					{
						...
						action: 'Cập nhật phiếu chuyển kho',
					},
					{
						name: 'Lấy Danh Sách',
						value: 'getAll',
						description: 'Lấy danh sách phiếu chuyển kho',
						action: 'Lấy danh sách phiếu chuyển kho',
					},
					{
						name: 'Lấy Theo ID',
						value: 'get',
						description: 'Lấy phiếu chuyển kho theo ID',
						action: 'Lấy phiếu chuyển kho',
					},
					{
						name: 'Tạo Mới',
						value: 'create',
						description: 'Tạo phiếu chuyển kho mới',
						action: 'Tạo phiếu chuyển kho',
					},
					{
						name: 'Xoá',
						value: 'delete',
						description: 'Xoá phiếu chuyển kho',
						action: 'Xoá phiếu chuyển kho',
					},
				],
				default: 'getAll',
			},
